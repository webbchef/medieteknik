        ...
        <Container maxWidth="lg">
            <ImageWithSummary imageSrc={require("../../assets/3cant.jpg")} direction="row-reverse">
              <Stack>
                ...
                <Typography variant="body1" align="center" sx={{ color: "inherit", fontSize: "24px"}}>3Cant är festeriet för civilinjengörerna i Norrköping. De arrangerar fester i alla dess slag bla bla bla bla."</Typography>
                <Button href="https://www.3cant.com/" variant="contained" size="large" sx={{ margin: "20px auto", backgroundColor: "#EC6610", color: "inherit" }}>Läs Mer</Button>
              </Stack>
            </ImageWithSummary>
            <ImageWithSummary imageSrc={require("../../assets/mette.jpg")} direction="row">
              <Stack>
                <Typography variant="h2" align="center" sx={{ color: "inherit" }} >METTE</Typography>
                <Typography variant="body1" align="center" sx={{ color: "inherit", fontSize: "24px"}}>Mette är sektionens tjejförening som jobbar för att främja gemenskapen mellan alla tjejer och icke-binära på MT-programmet!</Typography>
                <Button href="" variant="contained" size="large" sx={{ margin: "20px auto", backgroundColor: "#EC6610", color: "inherit" }}>Läs Mer</Button>
              </Stack>
            </ImageWithSummary>
        </Container>
      </WavyBackground>
